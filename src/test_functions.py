from marker_related import create_codeword, create_marker_code, create_codeword_bit
...
def test_symbol(Pd_array, Pi_array, Ps_array, Nc, marker_code, message_length,n, 
    ...
    for i, test_point in enumerate(test_points):
        ...
        while fer_total <= max_fer and code_simulated <= max_codes:
            ...
            if symbol_bit != 1:
                testX = create_codeword(y, message_length, rate, gamma, numT, symbol_bit, 1, numR, Nc, Nr)
            else:
